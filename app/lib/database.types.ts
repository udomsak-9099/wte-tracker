  ...
  public: {
    Tables: {
      ...
      environmental_records: {
        Row: { category: string | null; created_at: string | null; id: string; notes: string | null; parameter: string; record_date: string; recorded_by: string | null; status: Database["public"]["Enums"]["compliance_status"] | null; threshold_max: number | null; threshold_min: number | null; unit: string | null; value: number | null }
        Insert: { category?: string | null; created_at?: string | null; id?: string; notes?: string | null; parameter: string; record_date: string; recorded_by?: string | null; status?: Database["public"]["Enums"]["compliance_status"] | null; threshold_max?: number | null; threshold_min?: number | null; unit?: string | null; value?: number | null }
        Update: { category?: string | null; created_at?: string | null; id?: string; notes?: string | null; parameter?: string; record_date?: string; recorded_by?: string | null; status?: Database["public"]["Enums"]["compliance_status"] | null; threshold_max?: number | null; threshold_min?: number | null; unit?: string | null; value?: number | null }
      }
      epc_daily_reports: {
      ...
      equipment_items: {
        Row: { country_of_origin: string | null; created_at: string | null; description: string | null; epc_system_id: string | null; id: string; manufacturer_org_id: string | null; name: string; notes: string | null; po_number: string | null; quantity: number | null; unit_value: number | null; updated_at: string | null }
        Insert: { country_of_origin?: string | null; created_at?: string | null; description?: string | null; epc_system_id?: string | null; id?: string; manufacturer_org_id?: string | null; name: string; notes?: string | null; po_number?: string | null; quantity?: number | null; unit_value?: number | null; updated_at?: string | null }
        Update: { country_of_origin?: string | null; created_at?: string | null; description?: string | null; epc_system_id?: string | null; id?: string; manufacturer_org_id?: string | null; name?: string; notes?: string | null; po_number?: string | null; quantity?: number | null; unit_value?: number | null; updated_at?: string | null }
      }
      equipment_shipments: {
      ...
      equity_calls: {
        Row: { amount: number; call_date: string; created_at: string | null; currency: string | null; id: string; investor_org_id: string | null; notes: string | null; reference: string | null; related_milestone_id: string | null }
        Insert: { amount: number; call_date: string; created_at?: string | null; currency?: string | null; id?: string; investor_org_id?: string | null; notes?: string | null; reference?: string | null; related_milestone_id?: string | null }
        Update: { amount?: number; call_date?: string; created_at?: string | null; currency?: string | null; id?: string; investor_org_id?: string | null; notes?: string | null; reference?: string | null; related_milestone_id?: string | null }
      }
      issues: {
      ...
      loan_drawdowns: {
        Row: { amount: number; bank_org_id: string | null; created_at: string | null; currency: string | null; drawdown_date: string; id: string; interest_rate: number | null; notes: string | null; reference: string | null; related_milestone_id: string | null }
        Insert: { amount: number; bank_org_id?: string | null; created_at?: string | null; currency?: string | null; drawdown_date: string; id?: string; interest_rate?: number | null; notes?: string | null; reference?: string | null; related_milestone_id?: string | null }
        Update: { amount?: number; bank_org_id?: string | null; created_at?: string | null; currency?: string | null; drawdown_date?: string; id?: string; interest_rate?: number | null; notes?: string | null; reference?: string | null; related_milestone_id?: string | null }
      }
      organizations: {
      ...
      payment_milestones: {
        Row: { amount: number; created_at: string | null; description: string | null; due_date: string | null; funding_source: Database["public"]["Enums"]["funding_source"] | null; id: string; invoice_ref: string | null; name: string; paid_date: string | null; status: string | null; updated_at: string | null }
        Insert: { amount: number; created_at?: string | null; description?: string | null; due_date?: string | null; funding_source?: Database["public"]["Enums"]["funding_source"] | null; id?: string; invoice_ref?: string | null; name: string; paid_date?: string | null; status?: string | null; updated_at?: string | null }
        Update: { amount?: number; created_at?: string | null; description?: string | null; due_date?: string | null; funding_source?: Database["public"]["Enums"]["funding_source"] | null; id?: string; invoice_ref?: string | null; name?: string; paid_date?: string | null; status?: string | null; updated_at?: string | null }
      }
      permits: {
        Row: { authority: string | null; checklist: Json | null; created_at: string | null; expiry_date: string | null; id: string; issue_date: string | null; name: string; notes: string | null; progress: number | null; ref_number: string | null; status: Database["public"]["Enums"]["permit_status"] | null; updated_at: string | null }
        Insert: { authority?: string | null; checklist?: Json | null; created_at?: string | null; expiry_date?: string | null; id?: string; issue_date?: string | null; name: string; notes?: string | null; progress?: number | null; ref_number?: string | null; status?: Database["public"]["Enums"]["permit_status"] | null; updated_at?: string | null }
        Update: { authority?: string | null; checklist?: Json | null; created_at?: string | null; expiry_date?: string | null; id?: string; issue_date?: string | null; name?: string; notes?: string | null; progress?: number | null; ref_number?: string | null; status?: Database["public"]["Enums"]["permit_status"] | null; updated_at?: string | null }
      }
      permits_to_work: {
        Row: { approved_by: string | null; created_at: string | null; end_time: string | null; id: string; issued_to: string | null; location: string | null; ptw_number: string | null; ptw_type: string; start_time: string | null; status: string | null; updated_at: string | null; work_description: string | null }
        Insert: { approved_by?: string | null; created_at?: string | null; end_time?: string | null; id?: string; issued_to?: string | null; location?: string | null; ptw_number?: string | null; ptw_type: string; start_time?: string | null; status?: string | null; updated_at?: string | null; work_description?: string | null }
        Update: { approved_by?: string | null; created_at?: string | null; end_time?: string | null; id?: string; issued_to?: string | null; location?: string | null; ptw_number?: string | null; ptw_type?: string; start_time?: string | null; status?: string | null; updated_at?: string | null; work_description?: string | null }
      }
      phases: {
      ...
      safety_incidents: {
        Row: { created_at: string | null; description: string | null; id: string; incident_date: string; incident_type: string | null; location: string | null; reported_by: string | null; resolution: string | null; resolved_date: string | null; severity: Database["public"]["Enums"]["issue_severity"] | null; updated_at: string | null }
        Insert: { created_at?: string | null; description?: string | null; id?: string; incident_date: string; incident_type?: string | null; location?: string | null; reported_by?: string | null; resolution?: string | null; resolved_date?: string | null; severity?: Database["public"]["Enums"]["issue_severity"] | null; updated_at?: string | null }
        Update: { created_at?: string | null; description?: string | null; id?: string; incident_date?: string; incident_type?: string | null; location?: string | null; reported_by?: string | null; resolution?: string | null; resolved_date?: string | null; severity?: Database["public"]["Enums"]["issue_severity"] | null; updated_at?: string | null }
      }
      safety_inspections: {
        Row: { action_required: string | null; created_at: string | null; findings: string | null; id: string; inspection_date: string; inspection_type: string | null; inspector_id: string | null; location: string | null; status: string | null }
        Insert: { action_required?: string | null; created_at?: string | null; findings?: string | null; id?: string; inspection_date: string; inspection_type?: string | null; inspector_id?: string | null; location?: string | null; status?: string | null }
        Update: { action_required?: string | null; created_at?: string | null; findings?: string | null; id?: string; inspection_date?: string; inspection_type?: string | null; inspector_id?: string | null; location?: string | null; status?: string | null }
      }
      safety_trainings: {
        Row: { attendees: Json | null; created_at: string | null; id: string; notes: string | null; topic: string; trainer: string | null; training_date: string }
        Insert: { attendees?: Json | null; created_at?: string | null; id?: string; notes?: string | null; topic: string; trainer?: string | null; training_date: string }
        Update: { attendees?: Json | null; created_at?: string | null; id?: string; notes?: string | null; topic?: string; trainer?: string | null; training_date?: string }
      }
      tasks: {
